...
try:
    while True:
        ...
        if control_mode == "XYZ":
            ...
            if is_pressed('w'): target_x += XYZ_STEP; xyz_updated = True
            elif is_pressed('s'): target_x -= XYZ_STEP; xyz_updated = True
            
            if is_pressed('a'): target_y += XYZ_STEP; xyz_updated = True
            elif is_pressed('d'): target_y -= XYZ_STEP; xyz_updated = True
            
            if is_pressed('q'): target_z += XYZ_STEP; xyz_updated = True
            elif is_pressed('e'): target_z -= XYZ_STEP; xyz_updated = True
